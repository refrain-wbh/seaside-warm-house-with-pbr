...
int main()
{
    ...
    IBLMAPS iblMaps = GetIBLMAPS(envCubemap, window);
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_CUBE_MAP, iblMaps.irradianceMap);
        glActiveTexture(GL_TEXTURE1);
        glBindTexture(GL_TEXTURE_CUBE_MAP, iblMaps.prefilterMap);
        glActiveTexture(GL_TEXTURE2);
        glBindTexture(GL_TEXTURE_2D, iblMaps.brdfLUTTexture);
